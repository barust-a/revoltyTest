...
The documentation workflow (see `AGENTS.md` §1):

- `specs/` — approved designs, `YYYY-MM-DD-<topic>-design.md`, written BEFORE planning.
- `plans/` — TDD implementation plans, `YYYY-MM-DD-<topic>.md`, written BEFORE coding.
